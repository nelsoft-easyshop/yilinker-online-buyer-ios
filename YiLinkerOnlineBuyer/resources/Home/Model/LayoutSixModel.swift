...
class LayoutSixModel: NSObject {
    ...
    class func parseDataFromDictionary(dictionary: NSDictionary) -> LayoutSixModel {
        var layoutId: Int = 0
        var sectionTitle: String = ""
        var isViewMoreAvailable: Bool = false
        var viewMoreTarget: TargetModel = TargetModel()
        ...
        return LayoutSixModel(layoutId: layoutId, sectionTitle: sectionTitle, isViewMoreAvailable: isViewMoreAvailable, viewMoreTarget: viewMoreTarget, data: data)
    }
}
