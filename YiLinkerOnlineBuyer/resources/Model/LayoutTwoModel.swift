...
class LayoutTwoModel: NSObject {
    ...
    class func parseDataFromDictionary(dictionary: NSDictionary) -> LayoutTwoModel {
        var layoutId: Int = 0
        var sectionTitle: String = ""
        var isViewMoreAvailable: Bool = false
        var viewMoreTarget: TargetModel = TargetModel()
        ...
        return LayoutTwoModel(layoutId: layoutId, sectionTitle: sectionTitle, isViewMoreAvailable: isViewMoreAvailable, viewMoreTarget: viewMoreTarget, data: data)
    }
}
