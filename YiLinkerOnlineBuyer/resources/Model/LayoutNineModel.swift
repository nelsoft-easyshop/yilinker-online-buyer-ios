...
class LayoutNineModel: NSObject {
    var layoutId: Int = 0
    ...
    class func parseDataFromDictionary(dictionary: NSDictionary) -> LayoutNineModel {
        var layoutId: Int = 0
        var sectionTitle: String = ""
        var isViewMoreAvailable: Bool = false
        var viewMoreTarget: TargetModel = TargetModel()
        ...
        return LayoutNineModel(layoutId: layoutId, sectionTitle: sectionTitle, isViewMoreAvailable: isViewMoreAvailable, viewMoreTarget: viewMoreTarget, data: data)
    }
}
