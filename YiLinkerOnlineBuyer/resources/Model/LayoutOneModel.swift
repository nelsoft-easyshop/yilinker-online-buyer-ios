...
class LayoutOneModel: NSObject {
    ...
    class func parseDataFromDictionary(dictionary: NSDictionary) -> LayoutOneModel {
        var layoutId: Int = 0
        var sectionTitle: String = ""
        var isViewMoreAvailable: Bool = false
        var viewMoreTarget: TargetModel = TargetModel()
        ...
        return LayoutOneModel(layoutId: layoutId, sectionTitle: sectionTitle, isViewMoreAvailable: isViewMoreAvailable, viewMoreTarget: viewMoreTarget, data: data)
    }
}
