...
class LayoutTenModel: NSObject {
    ...
    class func parseDataFromDictionary(dictionary: NSDictionary) -> LayoutTenModel {
        var layoutId: Int = 0
        var sectionTitle: String = ""
        var isViewMoreAvailable: Bool = false
        var viewMoreTarget: TargetModel = TargetModel()
        ...
        return LayoutTenModel(layoutId: layoutId, sectionTitle: sectionTitle, isViewMoreAvailable: isViewMoreAvailable, viewMoreTarget: viewMoreTarget, data: data)
    }
}
